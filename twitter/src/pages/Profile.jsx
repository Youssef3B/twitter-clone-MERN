...
function Profile() {
  return (
    <div className="border border-stone-800 p-4 col-span-3 lg:col-span-2 space-y-6 ">
      ...
      <div className="">
        <h3 className="text-3xl font-bold mb-1">Code With Youssef</h3>
        <span className="text-gray-400">@codewithyoussef</span>
        <h4 className="mt-3 font-semibold">Hello, my name is Youssef!</h4>
